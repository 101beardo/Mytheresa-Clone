...
const getWishData=()=>(dispatch)=>{
    ...
    return axios.get('https://jsondeployment-lyna.vercel.app/wish')
...
const addWishData=(payload)=>(dispatch)=>{
    ...
    return axios
    .post('https://jsondeployment-lyna.vercel.app/wish',payload)
    .then((r)=>{
...
const getCartData=()=>(dispatch)=>{
    ...
    return axios.get('https://jsondeployment-lyna.vercel.app/bag')
...
const addCartData=(payload)=>(dispatch)=>{
    ...
    return axios
    .post('https://jsondeployment-lyna.vercel.app/bag',payload)
    .then((r)=>{
...
const addData=(payload)=>(dispatch)=>{
    ...
    return axios
    .post('https://jsondeployment-lyna.vercel.app/mens',payload)
    .then((r)=>{
...
const updateData=(id,payload)=>(dispatch)=>{
    ...
    return axios
    .patch(`https://jsondeployment-lyna.vercel.app/mens/${id}`,payload)
    .then((r)=>{
...
const deleteData=(id)=>(dispatch)=>{
    ...
    return axios
    .delete(`https://jsondeployment-lyna.vercel.app/mens/${id}`)
    .then((r)=>{
...
const deleteCartData=(id)=>(dispatch)=>{
    ...
    return axios
    .delete(`https://jsondeployment-lyna.vercel.app/bag/${id}`)
    .then((r)=>{
...
const deleteWishData=(id)=>(dispatch)=>{
    ...
    return axios
    .delete(`https://jsondeployment-lyna.vercel.app/wish/${id}`)
    .then((r)=>{
