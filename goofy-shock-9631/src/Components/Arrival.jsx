...
<Box display="flex" w={["","","","20%"]} m={["auto","auto","auto","auto"]} >
    ...
    {/* <Box  display='flex' justifyContent='space-evenly' border="1px solid red">
          ...
          currentTableData.map((item)=>{
            return(
                    <Box p="50px" m="50px" align="center" borderRadius="5%" boxShadow="dark-lg" key={item.id}>
                     ...
                     <Box display={['block','block','block']} justifyContent={["space-between","space-evenly",'space-between']}>
...
<Box pt="4%" w="100%" display={["block","block","flex","flex"]} border="px solid red" gap={["20px","20px","20px","20px"]} >
  ...
  <AccordionItem>
    ...
    <AccordionPanel pb={4}>
    <Checkbox  onChange={handleSort} defaultChecked={sort==="asc"} value="asc" name="sortBy" colorScheme='green' color="rgb(153, 153, 153)">
      Price (High To Low)
  </Checkbox>
